...
designated successor. Updates or deletions of tokens from the registration follow
the same procedures.
...
To ensure widespread usability across protocols, tokens MUST follow the character
set restrictions for XML Names [3].
